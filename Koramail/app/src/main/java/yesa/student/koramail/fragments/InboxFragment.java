...
import yesa.student.koramail.adapters.InboxRecyclerViewAdapter;
...
public class InboxFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        inboxRecyclerViewAdapter = new InboxRecyclerViewAdapter(mails, getContext());
    ...
    private void getMails() {
        Call<List<Mail>> get = apiServices.getInbox(preference.getEmail());
